...
<p class="auto-style1"><strong>Is there currently a callwave in LT?</strong></p>



<div id="theD" style="left: 0%; top: 14%; width: 100%; height: 87%; padding:0;" >
	<iframe id="if" width="100%" height="100%" border="0" frameBorder="5" src="http://sdet2125/callwelle.php">iFrame</iframe>
</div>
...
$("#if").attr('src',"http://sdet2125/callwelle.php");
