...
for($d=60;$d>=0;$d--) {
	...
	if ($wd != 0 && $wd !=6 && strtotime("-".$d." day 00:00:01") >= 1413756001 && $row["erg"]>0)  {
		...
		//$linkArr[] = "<a href='/Vorschlag.php?stamp=".strtotime("-".$d." day 00:00:01")."&sd=1&cn=0"."&name=".$dateStringB."' >".strftime("%B", strtotime("-".$d." day 00:00:01"))."<b>".strftime(" %d", strtotime("-".$d." day 00:00:01"))."</b>".strftime(", %Y", strtotime("-".$d." day 00:00:01"))." </a>";
		$linkArr[] = "<a class='asize' href='#cn=0' onClick=\"OpenInNewTab('/Vorschlag.php?stamp=".strtotime("-".$d." day 00:00:01")."&sd=1&cn=0"."&name=".$dateStringB."')\" >".strftime("%B", strtotime("-".$d." day 00:00:01"))."<b>".strftime(" %d", strtotime("-".$d." day 00:00:01"))."</b>".strftime(", %Y", strtotime("-".$d." day 00:00:01"))." </a>";
		$dowArr[] = $wd; 
	}
}
...
<br><br>
<input class="boton2 gradient" onclick="location='http://sdet2125'" type="button" value="Home"> 
<br><br>
