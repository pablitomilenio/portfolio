...
?>
	...
	<div id="cont" style="position:absolute" class="trans">
			<img id="indic" class="arrow" src="img/zeiger_neu rot.png" style="">
	</div>
...
function AnimateRotate(angle) {
	...
	$('#cont').show();
	//color	
	if (angle < 85 && angle >= 80 ) $('#indic').attr('src','/img/zeiger_neu gelb.png');
	if (angle < 80 ) $('#indic').attr('src','img/zeiger_neu rot.png');
	if (angle >= 85 ) $('#indic').attr('src','img/zeiger_neu gruen.png');
