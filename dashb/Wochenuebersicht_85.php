...
<title>Liveticker - Tagesauswahl</title>
...
<h1><span class="inset">Available Workdays: Starting at 85%</span></h1>
...
for($d=60;$d>=0;$d--) {
	...
	if ($wd != 0 && $wd !=6 && strtotime("-".$d." day 00:00:01") >= 1434319201 && $row["erg"]>0)  {
	    $dateStringB = strftime("%B", strtotime("-".$d." day 00:00:01")).strftime(" %d", strtotime("-".$d." day 00:00:01")).strftime(", %Y", strtotime("-".$d." day 00:00:01"));
		$linkArr[] = "<a href='/Liveticker_Enorm.php?stamp=".strtotime("-".$d." day 00:00:01")."&sd=1&cn=0"."&name=".$dateStringB."' >".strftime("%B", strtotime("-".$d." day 00:00:01"))."<b>".strftime(" %d", strtotime("-".$d." day 00:00:01"))."</b>".strftime(", %Y", strtotime("-".$d." day 00:00:01"))." </a>";
		$dowArr[] = $wd; 
	}
}
