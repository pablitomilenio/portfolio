   ...
   /* function getXPixel(val) {
	...
	$(document).ready(function() {
		...
		for(var i = 0; i < yes.length; i ++) {  
			...
			dipos = getYPixel(yes[i]);
			$("#eingabe").css("top",Math.min(dipos+61,screen.height-170));
...
<script>
l=0;
//theInt = setInterval("location.reload();",2000);

theInt = setInterval("rs();",300);
...
function rs(){
   ...
   if (l > vals.length-2) clearInterval(theInt);
}
