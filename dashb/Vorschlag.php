...
//	if (isNaN(CallsLT[a]/CallsFesto[a]) || (CallsLT[a]/CallsFesto[a] == 1)) Enorm.push(85);
	if (isNaN(CallsLT[a]/CallsFesto[a]) ||  (CallsLT[a] <= 4)     ) Enorm.push(85);
	else {
		 //(((CallsLT[a]/CallsFesto[a]) == 1) && (CallsLT[a] > 6) Enorm.push(100* (CallsLT[a])/(CallsFesto[a])   );
		 if ((CallsLT[a]/CallsFesto[a]) == 1)   Enorm.push(100* (CallsLT[a]-1)/(CallsFesto[a])   );
		 else Enorm.push(100* (CallsLT[a])/(CallsFesto[a])   );
		//console.log(CallsLT[a]);
	}
}
