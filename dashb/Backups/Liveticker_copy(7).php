...
<script>
$('#theFill').width(window.innerWidth-165);
$('#theFill').height(window.innerHeight-70);
$('#theFill').css('left','110px');
...
//		c.fillText(60+"% -", xPadding + 0, getYPixel(60-cutOff));		
		...
		for(var i = 0; i < yes.length; i ++) {  
			...
			$("#timeDisp").css("left",(parseInt($("#percWindow").css("left"))+65)+"px");		
...
//		if (!(currentHour >=0)) $("#timeDisp").hide(0);
	...
	{
		$("#hour1").attr("src","Ziffern/"+timeString.substr(0, 1)+".png");
		$("#hour2").attr("src","Ziffern/"+timeString.substr(1, 1)+".png");
		$("#minute1").attr("src","Ziffern/"+timeString.substr(3, 1)+".png");
		$("#minute2").attr("src","Ziffern/"+timeString.substr(4, 1)+".png");

	}
	else {
		$("#hour1").attr("src","Ziffern/0.png");
		$("#hour2").attr("src","Ziffern/"+timeString.substr(0, 1)+".png");
		$("#minute1").attr("src","Ziffern/"+timeString.substr(2, 1)+".png");
		$("#minute2").attr("src","Ziffern/"+timeString.substr(3, 1)+".png");
	}
