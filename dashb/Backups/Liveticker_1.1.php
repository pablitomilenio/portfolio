...
<div id="percWindow" style="left:0px; top : 112px; height: 108px; width: 218px; position:absolute; ">
...
$("#timeDisp").css("top",  window.innerHeight/2-108/2);
...
if ((dival - cutOff)<llim) toggleClass("Red");
   ...
   if (l > vals.length-2) {
   		...
   		theRel = setInterval("location.href='Liveticker.php?cont=1';",2000);
   	}
}
